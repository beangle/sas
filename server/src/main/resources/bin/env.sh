...
export beangle_commons_ver=6.0.1
export beangle_template_ver=0.2.4
export beangle_boot_ver=0.1.25
...
export tomcat_ver=11.0.18
export undertow_ver=2.3.22.Final
